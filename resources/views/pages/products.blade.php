...
<div class="bg-[#d8e0a5] min-h-[80vh]">
    <div class="container  px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
            ...
            {{-- single product --}}
            <a href="{{route('product.show',['product'=>$product->id])}}" class="group relative bg-[#faf3e6]  rounded-b-md hover:scale-105 transition-all duration-200 cursor-pointer">
                <div class="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-t-md  lg:aspect-none  lg:h-80">
                    <img src="{{ asset('images/product.jpg') }}" alt="Front of men&#039;s Basic Tee in black." class="h-full w-full object-cover object-center lg:h-full lg:w-full">
                </div>
